...
- Not the dedicated timeline page ([052-activity-timeline.md](./052-activity-timeline.md)),
...
- Related: [052-activity-timeline.md](./052-activity-timeline.md) (separate dedicated
  page), [035-workflow-optimization.md](./035-workflow-optimization.md).
