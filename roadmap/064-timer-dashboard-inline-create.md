...
Follow-up promised by `048-inline-entity-creation.md` (see its Scope and Timer
...
- Reuse the inline-create endpoints (`/app/crud/inline/<entity>/new` + POST)
  shipped by `048-inline-entity-creation.md` — this is a new consumer surface,
...
- Blocked by `048-inline-entity-creation.md` Phases 1–2. List-view/dashboard
  surfaces beyond timers stay out.

## Context

- Parent spec: `048-inline-entity-creation.md` (Timer integration + Scope).
