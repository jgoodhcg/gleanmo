...
This work unit and `roadmap/029-search-filter.md` share a UI primitive (a
text-input-with-results-list) but operate at different layers:
`029-search-filter.md` is about narrowing list views; this work unit is about
...
- **Out of scope here:** true inline-create on the timer dashboard
  ...
  Tracked as a follow-up work unit `064-timer-dashboard-inline-create.md`.
...
- List-view text filtering (tracked separately in `roadmap/029-search-filter.md`).
...
- `roadmap/029-search-filter.md` — list-view text filtering. Complementary; shares
  ...
  other. `029-search-filter.md`'s "Timer Pages" section explicitly calls out the
  timer dashboard as a separate case — its concerns are addressed here by the
  tactical bounce-link fix and the follow-up `064-timer-dashboard-inline-create.md`
  work unit.
- Future `roadmap/064-timer-dashboard-inline-create.md` — true inline-create on the
  timer dashboard's parent-picker (replacing the tactical bounce-link shipped
  by this work unit). Out of scope here.
- `roadmap/060-keyboard-navigation.md` — keyboard a11y across forms. The
