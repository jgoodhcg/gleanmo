...
([061-ai-assistance.md](./061-ai-assistance.md)) and is out of scope here.
...
1. **Entity export** — flat, generic, driven off the Malli schema. Works for
   ...
   [056-cronometer-integration.md](./056-cronometer-integration.md)) get export for
...
2. **Composite export** — a named, hand-shaped export for entity groups whose
   ...
   ([075-exercise-export.md](./075-exercise-export.md)): session → set → line, where a
...
- `assemble` takes `{:keys [db user-id from until]}` and returns plain data.
  ...
  running app.
- Exercise is the first entry ([075-exercise-export.md](./075-exercise-export.md)). A
...
- No API, CLI, or MCP server — that is [061-ai-assistance.md](./061-ai-assistance.md).
...
- Consumers: [075-exercise-export.md](./075-exercise-export.md) (first composite),
  [056-cronometer-integration.md](./056-cronometer-integration.md) (first new entities
  to ride the generic exporter).
- Retirement: this page is retired, or kept as a convenience, when
  [061-ai-assistance.md](./061-ai-assistance.md) ships.
