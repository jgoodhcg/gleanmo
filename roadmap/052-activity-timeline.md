...
- Related: [029-search-filter.md](./029-search-filter.md) for search infrastructure
...
- Related work: [035-workflow-optimization.md](./035-workflow-optimization.md) for dashboard improvements
