...
- Open questions: Which metadata source should we use for lookups, and how much data should be stored?
...
See also: [Reading Airtable Schema (Reference)](./023-reading-airtable-spec.md) for the source tables we need to map into Malli schemas and migration helpers.
