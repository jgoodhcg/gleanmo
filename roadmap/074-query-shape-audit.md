...
**Sequencing: do this after [071-timer-running-flag.md](./071-timer-running-flag.md).**
...
- [ ] Findings appended to [013-dashboard-performance.md](./013-dashboard-performance.md)

## Scope

Not included: adding attributes to make queries faster. That is a modeling
decision per case (see the Notes in 071-timer-running-flag.md for when it is
...
- `roadmap/013-dashboard-performance.md` — the measurements that motivated this
- `roadmap/071-timer-running-flag.md` — do that first
