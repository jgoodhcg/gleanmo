...
2s outlier is *not* row count — suspect doc/index bloat (see 054-bm-log-bloating.md)
...
Written up as its own work unit — [071-timer-running-flag.md](./071-timer-running-flag.md).
...
[021-performance.md](./021-performance.md)). Instance age was therefore unknown, and
...
[071-timer-running-flag.md](./071-timer-running-flag.md) is on the working tree, not
