...
[014-data-migration-status.md](./014-data-migration-status.md)). The same workflow
needs a new source.

**This unit is now scoped as one composite export inside
[078-data-export.md](./078-data-export.md), not as its own page.** The page, the date
...
[078-data-export.md](./078-data-export.md).
...
All three formats defined in [078-data-export.md](./078-data-export.md) apply. The
...
- The export page, date controls, copy button, format and relation controls —
  all [078-data-export.md](./078-data-export.md).
- No API, CLI, or MCP server (that's
  [061-ai-assistance.md](./061-ai-assistance.md)).
...
- Depends on [078-data-export.md](./078-data-export.md); ship that page first, or ship
...
- DB-layer rule: all access via `db/queries.clj`; never `xt/q`/`xt/entity`
  outside it.
- Relationship to the bigger goal: [061-ai-assistance.md](./061-ai-assistance.md) is
...
The reason this is its own work unit and not folded into 061-ai-assistance.md: the
...
([056-cronometer-integration.md](./056-cronometer-integration.md)): a second
...
and the generic exporter moved to [078-data-export.md](./078-data-export.md); this unit
