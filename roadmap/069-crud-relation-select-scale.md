...
(see [015-exercise.md](./015-exercise.md)), but every other high-cardinality parent
...
- Prior art for bounded reads: `roadmap/013-dashboard-performance.md` (scan-then-pull)
