...
> **ABSORBED into `065-navigation-redesign.md` (2026-07-28).** The tab bar
...
(`043-pwa-experience.md`) — in standalone mode there is no browser chrome, so
...
- No desktop tab bar. No gesture navigation. No offline/service-worker work
  (that's `043-pwa-experience.md`).

## Context

- Mobile menu button + sidebar toggle: `app/shared.clj:172-199`.
- Static quick actions shipped first in `063-qol-quick-actions.md` (sidebar +
