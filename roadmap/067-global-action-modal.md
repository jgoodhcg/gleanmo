...
gets it for free — this is the reason `archived/065-navigation-redesign.md` consolidated
...
wholesale to modals, and animation polish (`041-ui-juice.md` owns motion).
...
- Accessibility expectations: `roadmap/060-keyboard-navigation.md`.
