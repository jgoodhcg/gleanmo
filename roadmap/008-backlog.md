...
- Desktop QOL counterpart to the mobile quick actions in `063-qol-quick-actions.md`
...
- Pairs with `060-keyboard-navigation.md`
...
- **See also**: `033-today-navigation.md` covers richer focus date filtering on the today page specifically.
