...
1. **Snapshots are manual.** `obs/persist-instance-snapshot!` has exactly one
   ...
   [021-performance.md](./021-performance.md) called for a 60-second flush task. It was
...
2026-08-13 baseline in [071-timer-running-flag.md](./071-timer-running-flag.md) is the
...
[021-performance.md](./021-performance.md) and is independent of this.
...
- `src/tech/jgood/gleanmo/worker.clj` — where a scheduled flush would live.
  ...
  before picking one
- [021-performance.md](./021-performance.md) — the original monitoring unit; this
  splits out its "cross-instance aggregation" follow-up
- [071-timer-running-flag.md](./071-timer-running-flag.md) — the 2026-08-13 baseline
