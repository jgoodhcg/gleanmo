...
(defn parse-enum
  [value mapping]
  (when value
    (get mapping (.toLowerCase value) nil)))
    ...
    (into
     ...
     (remove (fn [[k v]] (nil? v))
             {:xt/id                  (generate-deterministic-uuid id),
              ...
              :bm-log/pace            :typical, ; default since not in airtable
         ; data
              :bm-log/color           (parse-enum (get fields "color")
                                                  color-mapping),
              :bm-log/blood           (parse-enum (get fields "blood")
                                                  blood-mapping),
              :bm-log/mucus           (boolean (get fields "mucus")),
              :bm-log/urgency         (parse-enum (get fields "urgency")
                                                  urgency-mapping),
              :bm-log/incontinence    false, ; default since not in airtable
         ; data
              :bm-log/straining       (boolean (get fields "straining")),
              ...
              :bm-log/anxiety         (parse-enum (get fields "anxiety")
                                                  anxiety-mapping),
              :bm-log/feeling-of-completeness :complete, ; default since not in
         ; airtable data
              :bm-log/ease-of-passage :normal})))) ; default since not in airtable data
